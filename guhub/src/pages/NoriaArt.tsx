...
export function Hollow() {
  return (
    <svg className="art artHollow" viewBox="-40 -46 80 56" aria-hidden>
      ...
      <path d="M-22 8 C -26 -18 -12 -36 0 -36 C 12 -36 26 -18 22 8 Z" fill="#7a5c22" />
...
export function River() {
  return (
    <svg className="art artRiver" viewBox="0 0 1600 700" preserveAspectRatio="none" aria-hidden>
      ...
      <g stroke="#7a5c22" fill="none" strokeLinecap="round" strokeWidth="5">
        {Array.from({ length: 7 }).map((_, i) => (
          <path
            key={i}
            className="current"
  ...
  return (
    <svg className="art artScribe" viewBox="-90 -200 180 210" aria-hidden>
      <g fill="#0c0606">
        ...
        <path d="M0 8 L0 -60" stroke="#7a5c22" strokeWidth="2" fill="none" opacity="0.4" />
      ...
      <g className="scribeHand">
        ...
        <g className="scribeWriting" stroke="#7a5c22" strokeWidth="2" fill="none">
    ...
    <svg className="art artSquirrel" viewBox="-60 -70 130 90" aria-hidden>
      <g fill="#0c0606">
        ...
        <g className="squirrelHead">
          ...
          <circle cx="-22" cy="-22" r="1.6" fill="#7a5c22" />
...
export function TrunkDetail() {
  ...
  return (
    <svg className="art artTrunkDetail" viewBox="-130 -300 260 380" aria-hidden>
      <g stroke="#7a5c22" fill="none" strokeLinecap="round" opacity="0.8">
        {hatch.map((h, i) => (
  ...
  return (
    <svg className="art artBeetle" viewBox="-24 -14 48 28" aria-hidden>
      <g fill="#0c0606">
        ...
        <rect x="-1.2" y="-8" width="2.4" height="16" fill="#7a5c22" />
      </g>
